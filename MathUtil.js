...
MathUtil.parabole = function(obj, a, pas) {
    obj.x = a * Math.cos(obj.time / pas) * Math.cos(obj.time / pas) / Math.sin(obj.time / pas);
    obj.y = a * Math.sin(obj.time / pas) * Math.sin(obj.time / pas) / Math.cos(obj.time / pas);
}
MathUtil.boucle = function(obj, a, b, pas) {
    obj.x = a * Math.cos(obj.time / pas);
    obj.y = b * Math.sin(obj.time / pas);
}
